...
import { fetchMedications, updateMedication } from "./supabase"; // Importujeme funkce pro práci s databází
...
export default function InventoryScreen() {
    ...
    const handleBarcodeScanned = ({ data }) => {
        ...
        const matchedMedication = medications.find((med) => med.barcodes.includes(data));
        ...
        if (matchedMedication) {
            ...
            Vibration.vibrate();  // Vibration after successful scan
            Alert.alert("Medication Added", "The medication has been added to your inventory.");
        } else {
